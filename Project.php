                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Our Projects</h1>
                                    <!-- breadcrumb Start-->
                ...
                <div class="row">
                        ...
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="blog_image.png" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    <p>Project</p>
                                    <h3><a href="dlf.html">DLF</a></h3>
                                    <p>Experience premium living with DLF – a name synonymous with trust, luxury, and
                                        prime locations. Discover world-class amenities, vibrant communities, and
                                    ...
                                    <a href="dlf.html" class="border-btn border-btn2">Explore Project</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="shapoorji.png" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    <p>Project</p>
                                    <h3><a href="Shapoorji.html">Shapoorji Pallonji</a></h3>
                                    <p>Shapoorji and Pallonji is a premium residential project offering modern living
                                        with world-class amenities, sustainable design, and exceptional construction
                                        quality in a prime Gurgaon location.
                                    </p>
                                    <div class="properties__footer d-flex justify-content-between align-items-center">
                                        <!-- <div class="restaurant-name">
                                            <div class="rating">
                                    ...
                                    <a href="Shapoorji.html" class="border-btn border-btn2">Explore Project</a>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="omaxe.png" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    <p>Project</p>
                                    <h3><a href="Omaxe.html">Omaxe The State</a></h3>
                                    <p>Omaxe The State is a landmark commercial project offering premium retail spaces,
                                        offices, and entertainment zones, strategically located to boost growth in the
                                        heart of New Delhi.
                                    </p>
                                    <div class="properties__footer d-flex justify-content-between align-items-center">
                                        <!-- <div class="restaurant-name">
                                    ...
                                    <a href="Omaxe.html" class="border-btn border-btn2">Explore Project</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="Heritage_plot.png" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    <p>Project</p>
                                    <h3><a href="Heritage.html">Heritage Homes, Pataudi</a></h3>
                                    <p>Heritage Home offers well-planned residential plots in a peaceful setting with
                                        modern infrastructure, ideal for building your dream home in the growing
                                        location of Bhiwadi.
                                    </p>
                                    <div class="properties__footer d-flex justify-content-between align-items-center">
                                        <!-- <div class="restaurant-name">
                                    ...
                                    <a href="Heritage.html" class="border-btn border-btn2">Explore Project</a>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="Ganga.png" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    <p>Project</p>
                                    <h3><a href="ganga_realty.html">Ganga Realty</a></h3>
                                    <p>Ganga Realty is a modern residential project in Gurgaon, offering thoughtfully
                                        designed homes with premium amenities, and excellent connectivity for a
                                    ...
                                    <a href="ganga_realty.html" class="border-btn border-btn2">Explore Project</a>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="dubai.png" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    <p>Project</p>
                                    <h3><a href="Dubai.html">Danube Properties</a></h3>
                                    <p>Danube Properties in Dubai offers luxurious, affordable homes with world-class
                                        amenities, prime locations, and innovative designs, making it a top choice for
                                    ...
                                    <a href="Dubai.html" class="border-btn border-btn2">Explore Project</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="courses-area section-padding40 fix">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="section-tittle text-center mb-55">
                            <h2>Trending Properties on YouTube</h2>
                        </div>
                    </div>
                </div>
